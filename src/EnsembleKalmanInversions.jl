...
(See https://clima.github.io/EnsembleKalmanProcesses.jl/stable/ensemble_kalman_inversion/ for specifics
of the Ensemble Kalman Inversion algorithm.)
...
"""
    UnscentedKalmanInversion(inverse_problem, prior_mean, prior_cov; noise_covariance = 1e-2, α_reg = 1, update_freq = 0)
...
(See https://clima.github.io/EnsembleKalmanProcesses.jl/stable/unscented_kalman_inversion/ for specifics
of the Unscented Kalman Inversion algorithm.)
...
"""
function UnscentedKalmanInversion(inverse_problem, prior_mean, prior_cov; noise_covariance = 1e-2, α_reg = 1, update_freq = 0)
    free_parameters = inverse_problem.free_parameters
    original_priors = free_parameters.priors

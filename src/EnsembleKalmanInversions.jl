...
mutable struct EnsembleKalmanInversion{I, E, M, O, S, R, X, G, C}
    inverse_problem :: I
...
- `noise_covariance` (`Number` or `AbstractMatrix`): Covariance matrix representing observational uncertainty.
                                                     `noise_covariance::Number` is converted to `UniformScaling`.
...
#####
##### Iterating and stepping parameters forward
#####

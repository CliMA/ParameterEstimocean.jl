...
- `pseudo_stepping` (`Number`): The convergence rate for the EKI adaptive time stepping. Default value 0.7.
...
function step_parameters(eki::EnsembleKalmanInversion, pseudo_stepping, adaptive_step_parameters; Δt=1.0)
